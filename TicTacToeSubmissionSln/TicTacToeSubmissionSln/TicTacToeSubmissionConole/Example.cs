...
namespace TicTacToeSubmissionConole
{
    ...
    /*{
        ...
        {
            static char[] board = { ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ' };
            static int player = 1; // Player 1 starts the game
            ...
            static void Main(string[] args)
            {
                do
                {
                    ...
                    flag = CheckWin(); // Check if any player has won the game

                } while (flag != 1 && flag != -1);

                Console.Clear(); // Clear the console before displaying the final state of the board
                Board(); // Display the final state of the board
